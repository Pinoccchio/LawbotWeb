  ...
  theme: {
    extend: {
      colors: {
        ...
        // Enhanced LawBot Design System
        lawbot: {
          // Primary Blue Palette (matching Flutter app)
          blue: {
            50: "#eff6ff",
            100: "#dbeafe", 
            200: "#bfdbfe",
          ...
          // AI/Purple Palette for AI features
          purple: {
            50: "#faf5ff",
            100: "#f3e8ff",
            200: "#e9d5ff",
        ...
        status: {
          ...
          dismissed: "#64748b"    // Slate 500
        },
        evidence: {
          document: "#dc2626",  // Red 600
          image: "#3b82f6",     // Blue 500
          video: "#f97316",     // Orange 500
          audio: "#10b981",     // Emerald 500
          archive: "#a855f7"    // Purple 500
        }
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      fontFamily: {
        ...
        mono: ["Monaco", "Cascadia Code", "Consolas", "Courier New", "monospace"],
